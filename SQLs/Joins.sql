...
(006, 'Vipul', 'Diwan', 2000000, '14-06-11 09.00.00', 'Account'),
...
(004, 'Asst. Manager', '2026-06-11 00:00:00'),
...
SELECT * FROM Worker WHERE SALARY BETWEEN 20000 AND 100000;
...
SELECT w.*, b.* FROM Worker as w INNER JOIN Bonus as b
ON w.WORKER_ID = b.WORKER_REF_ID;

SELECT * FROM Worker AS w LEFT JOIN Bonus as b
ON w.WORKER_ID = b.WORKER_REF_ID
UNION
SELECT * FROM Worker AS w RIGHT JOIN Bonus as b
ON w.WORKER_ID = b.WORKER_REF_ID;
